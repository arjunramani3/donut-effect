...
df <- readxl::read_excel('~/Documents/zillow/thesis/data/external_data/holian_cbd_geocodes.xlsx', 
...
latlonzip <- read_delim('~/Documents/zillow/thesis/data/external_data/us-zip-code-latitude-and-longitude.csv',
                        delim = ';') %>%
...
zip_chars <- read_csv('~/Documents/zillow/thesis/data/zip_all_chars.csv')
...
write_csv(zip_all_chars, '~/Documents/zillow/thesis/data/zip_all_chars_cbd.csv')
